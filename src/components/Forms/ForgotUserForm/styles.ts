...
export const StyledButton = styled.button<ButtonProps>`
  ...
  height: 44px;
  border-radius: 4px;
  background-color: ${props => props.disabled ? colors.actionColor : colors.disabledButtonColor};
  color: ${props => props.disabled ? colors.mainTextColor : colors.defaultTextColor};
