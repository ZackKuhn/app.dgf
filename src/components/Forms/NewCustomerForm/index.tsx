  ...
  <Container>
    {
      ...
      <StyledFormikForm>
        ...
        <StyledFormikInput name="bns_tag" placeholder="Setor de atuação "/>
        {/* <Field name={'bns_model'} component={StyledSelect} options={bns_model_items} placeholder="Modelo de negócios"/> */}
