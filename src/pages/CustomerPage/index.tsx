...
import { Container, Content, CustomerDataBox, CustomerHeader, CustomerName, CustomerPageDivider, DriveIcon, MetaIcon, AdsIcon } from './styles';
          ...
          customerData.map(customer => (
                ...
                <div className="RightBox">
                  ...
                  <div className="infoLabel" id="TicketMedio">
                    ...
                    <StyledText text={`R$${customer.ticket}`} size='base' bold accent/>
                  </div>
                  <div className="infoLabel" id="Margem">
                    <StyledText text='Mc' size='xs'bold/>
                    <StyledText text={`${customer.margin}%`} size='base' bold accent/>
                  </div>
                  <div className="RankingButtom">
                    <RankingStars rate={customer.rating}/>
                  </div>
              ...
              <CustomerDataBox>
                    ...
                    <div className="DataLine">
                      {
                        ...
                        <div key={item.id} className="DataField">
                          <div className="Data_infoSide">
                            ...
                            <StyledText text={item.data_value} size='base' bold accent />
                          </div>
                          <div className="Data_IndicatorSide">
                            <MoreOrLessIndicator value={item.indicator.value} refColor={item.indicator.effect}/>
                          </div>
                        </div>
                        ))
                      }
                  ...
                  <div className="ButtonContainer">
                      <div className="ButtonBox"><DriveIcon /></div>
                      <div className="ButtonBox"><AdsIcon /></div>
                      <div className="ButtonBox"><MetaIcon /></div>
                  </div>
              </CustomerDataBox>
              <CustomerStepBar />
              <ContactFooter />
